 ...
 *
 * 【题目】
 *  给定一个字符串str，返回str的统计字符串。例如，"aaabbadddffc"的统计字符串为
 *  "a_3_b_2_a_1_d_3_f_2_c_1"。
 *
 *  【补充题目】
 *   给定一个字符串的统计字符cstr，再给定一个整数index，返回cstr所代表的原始字
 *   符串的地index个字符。例如"a_1_b_100"所代表的原始字符串上第0个字符是'a'，第
 *   50个字符是'b'。
 */
public class _07GetCountString {
